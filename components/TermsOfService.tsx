                ...
                <div className="flex-1 overflow-y-auto p-6 custom-scrollbar space-y-6 text-text">
                    ...
                    <section>
                        ...
                        <div className="space-y-3 text-muted leading-relaxed">
                            ...
                            <p>
                                ...
                                </a>. This includes, but is not limited to, having your own Google account, being at least 18 years old, and using AI keys solely for development purposes. AI generated content may not be accurate or reliable, and you assume all risk and liability when using AI features. Flashcardsish does not inherently support, respect, or accept any content generated by AI, and you are solely responsible for the content you generate.
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-muted leading-relaxed mb-2">
                            <strong className="text-text">8.1 General Restrictions:</strong> You agree not to:
                        </p>
                        <ul className="list-disc pl-5 space-y-1 text-muted mb-4">
                        ...
                        <div className="p-4 bg-accent/5 border border-accent/20 rounded-xl">
                            <p className="text-muted leading-relaxed">
                                <strong className="text-accent">8.2 Developer API Use:</strong> Features labeled "Developer API Access" are strictly intended for software development, testing, and experimental purposes. By enabling these features, you represent and warrant that:
                            </p>
                            <ul className="list-disc pl-5 mt-2 space-y-1 text-muted">
                                <li>You are a developer acting in a professional or technical capacity.</li>
                                <li>You are providing your own API credentials ("Bring Your Own Key") for which you are the authorized owner.</li>
                                <li>You agree to be bound by the <a href="https://ai.google.dev/terms" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">Google Generative AI Terms of Service</a> and/or any other applicable third-party provider terms.</li>
                                <li>You will not use these features for production-grade consumer workflows or in violation of upstream API usage policies.</li>
                            </ul>
                        </div>
                    </section>
